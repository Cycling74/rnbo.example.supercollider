...
,
		...
		"tags" : "",
		"style" : "",
		"subpatcher_template" : "rnbo_basic",
		"showontab" : 1,
		"assistshowspatchername" : 0,
		"globalpatchername" : "max",
		"boxes" : [ 			{
				"box" : 				{
					"channels" : 1,
					"id" : "obj-82",
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 56.0, 181.0, 174.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 253.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 167.0, 216.0, 43.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 100.0, 101.0, 212.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"noinit" : 0,
										"steps" : 0.0,
										"minimum" : 0.0,
...
,
									"text" : "param freq 200 @min 20 @max 22100",
									"varname" : "freq"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 100.0, 162.0, 86.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"sync" : "off"
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 100.0, 216.0, 43.0, 23.0 ],
									"rnbo_extra_attributes" : 									{
										"comment" : ""
									}
,
...
,
					"patching_rect" : [ 56.0, 115.0, 101.0, 22.0 ],
					"rnboattrcache" : 					{
						"freq" : 						{
							"label" : "freq",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						"parameter_enable" : 1,
						"uuid" : "09b1bc63-be43-11eb-bc63-a683e7612c99"
					}
,
					"signalinletcount" : 0,
					"signaloutletcount" : 2,
...
,
							"__presetid" : "09b1bc63-be43-11eb-bc63-a683e7612c99"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "",
									"origin" : "09b1bc63-be43-11eb-bc63-a683e7612c99",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "",
										"filename" : "_20210526.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "253b3334140e859ef13fca5c2ac17108"
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 57.0, 150.0, 22.0 ]
				}
